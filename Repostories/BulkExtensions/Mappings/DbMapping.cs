...
namespace Repostories.BulkExtensions
{
    internal class DbMapping
    {
        ...
        {
            get { return this[tableType.Name]; }
        }

        public TableMapping this[string tableTypeName]
        {
            get { return _tableMappings[tableTypeName]; }
        }
        ...
        private void MapColumn(string identity, TableMapping tableMapping, EdmProperty property)
        {
            ...
            EdmMember edmMember = _tableColumnEdmMembers[identity].Find(c => c.Name == columnName);
            if (edmMember != null)
            {
