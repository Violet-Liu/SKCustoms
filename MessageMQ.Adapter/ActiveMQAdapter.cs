...
namespace MessageMQ.Adapter
{
    public class ActiveMQAdapter<T> : MQAdapterBase<T> where T : class
    {
        ...
        /// The log.
        /// </summary>
        private static readonly ILog log = LogManager.GetLogger("ActiveMQ");
        ...
        /// The <see cref="int"/>.
        /// </returns>
        public override int SendMessage<T>(T t, string selector = "")
        {
        ...
        /// <returns></returns>
        public override int SendMessages<T>(T[] t, string selector = "")
        {
        ...
        public override int SendMessages<T>(T[] t, string queneName, string selector = "")
        {
            int flag = 0;
            TryCatchGeneralExceptionWrapper(() =>
            {
        ...
        /// <typeparam name="T">
        /// </typeparam>
        private void ProductMessageProcess<T>(ISession session, T[] t, string queueName, string selector = "")
        {
        ...
        /// </exception>
        private static void SendTexts(ISession session, string[] texts, string topicName, string selector = "")
        {
